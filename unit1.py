...
Original file is located at
    https://colab.research.google.com/gist/techmehedi/3c7a351dd04ea04e7109a44830d3072d/unit1.ipynb
...
To push your trained model and potentially other files from this Colab environment to your GitHub repository, you'll need to perform the following git operations. Make sure you have executed the cells above to save your model (e.g., `ppo-LunarLander-v2.zip`).

**Note on Authentication:** For GitHub, you will likely need to use a [Personal Access Token (PAT)](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/creating-a-personal-access-token) for authentication when pushing from a non-interactive environment like Colab. You will be prompted to enter your username and PAT when `git push` runs.
"""
...
!git init
!git config --global user.name "techmehedi"
!git config --global user.email "ecommehedi@gmail.com"
